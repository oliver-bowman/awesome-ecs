...
- [Troposphere ECS](https://github.com/cloudtools/troposphere/blob/master/examples/ECSCluster.py) - Example the creation of an ecs cluster in troposphere a library to create AWS CloudFormation descriptions.
